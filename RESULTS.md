...
The current hard comparison quartet covers:
- identity
- value
- perception
- sound
...
The current difficulty phase now contains both success and failure modes, plus direct front-facing boundary comparison on identity, value, perception, and sound.
